...
Еще одно дополнение, которое можно установить, это **Дополнительные настройки GNOME**. Не очень рекомендую использовать их, как основные, но среди них есть очень полезные, каких не хватает в Pantheon Tweaks.
